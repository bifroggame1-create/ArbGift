        ...
        <div class="flex items-center justify-between mb-3">
          ...
          <div>
            ...
            <div class="text-2xl font-bold text-blue-400">
              <svg width="14" height="14" viewBox="0 0 56 56" fill="none" style="display:inline-block;vertical-align:middle;margin-right:3px">
        ...
        <div class="flex items-center justify-between">
          <div>
            ...
            <div class="text-3xl font-bold text-white">
              <svg width="16" height="16" viewBox="0 0 56 56" fill="none" style="display:inline-block;vertical-align:middle;margin-right:3px">
                <circle cx="28" cy="28" r="28" fill="#0098EA"/>
                <path d="M37.5603 15.6277H18.4386C14.9228 15.6277 12.6944 19.4202 14.4632 22.4861L26.2644 42.9409C27.0345 44.2765 28.9644 44.2765 29.7345 42.9409L41.5765 22.4861C43.3045 19.4202 41.0761 15.6277 37.5603 15.6277Z" fill="white"/>
              </svg>
